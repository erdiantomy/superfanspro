    ...
    return (
      <div style={{ height: "100dvh", background: C.bg, color: C.fg, maxWidth: 480, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, fontFamily: "'DM Sans', sans-serif" }}>
        <div style={{ width: "100%", maxWidth: 360, textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12, color: C.muted, marginTop: 4, marginBottom: 24 }}>superfanspro.vercel.app/admin</div>
          <input value={pass} onChange={e => setPass(e.target.value)} onKeyDown={e => e.key === "Enter" && setAuthed(true)} type="password" placeholder="Staff password" style={{ width: "100%", background: C.raised, border: `1px solid ${C.border}`, borderRadius: 12, padding: "12px 16px", color: C.fg, fontSize: 14, outline: "none", marginBottom: 10 }} />
          <button onClick={() => setAuthed(true)} style={{ width: "100%", background: C.orange, border: "none", color: "#0A0C11", padding: "13px 0", borderRadius: 12, fontFamily: "'Barlow Condensed'", fontSize: 16, fontWeight: 800, cursor: "pointer", marginBottom: 8 }}>ENTER →</button>
          ...
          <div style={{ fontSize: 10, color: C.dim, marginTop: 6 }}>Any password works in demo mode</div>
        </div>
      </div>
    );
  }
      ...
      <div style={{ padding: "12px 16px", borderBottom: `1px solid ${C.border}`, flexShrink: 0, background: "#0E0D0A" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            ...
            <div style={{ fontSize: 9, color: C.dim, letterSpacing: 1 }}>superfanspro.vercel.app/admin · Tom's Staff</div>
          </div>
